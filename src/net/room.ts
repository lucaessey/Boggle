/**
 * Multiplayer room operations over Firebase. All Firebase access lives in the
 * net/ module; the SDK bootstrap and anonymous auth are shared via ./firebase.
 */
import { type Fb, fb } from './firebase'
import { allocateRoomCode } from './roomCode'
import { joinability, type JoinResult, type RoomSettings, type RoomState } from './roomTypes'

// Re-exported for callers that only need auth (e.g. multiplayer bootstrap).
export { ensureAuth, currentUid } from './firebase'
